...
//
// This map is a fork of the official Go implementation, with the change of
// making it generic.
...
import (
	...
	"github.com/wzshiming/lru/internal/utils"
)
...
type entry[T any] struct {
	// p points to the T value stored for the entry.
	//
...
func (m *entry[T]) tryLoadOrStore(i T) (actual T, loaded, ok bool) {
	p := atomic.LoadPointer(&m.p)
	if p == expunged {
		return utils.Zero[T](), false, false
	}
	if p != nil {
